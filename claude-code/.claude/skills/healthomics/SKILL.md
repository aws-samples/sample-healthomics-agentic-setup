---
description: "AWS HealthOmics workflow development, migration, running, and debugging using the HealthOmics MCP server"
allowed-tools: Bash Read Write Edit mcp__aws-healthomics__*
---
