...
description: "AWS HealthOmics workflow development, migration, running, debugging, and optimization. Apply when user works with WDL, Nextflow, CWL, genomics pipelines, or HealthOmics."
globs:
  - "**/*.wdl"
  - "**/*.nf"
  - "**/*.cwl"
